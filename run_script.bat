...
REM start "" "C:\Program Files\Google\Chrome\Application\chrome.exe" --remote-debugging-port=9223 --user-data-dir="C:\Users\Administrator\AppData\Local\Google\Chrome\User Data\Default"
